...
# #  unified telemetry (tracing + prometheus)
# from ..telemetry import init_telemetry
# # helpers for metrics
# from ..metrics import TG_UPDATES, HANDLER_LAT, inc, observe
...
# def _wrap_with_graph(name: str, fn, graph):
#     async def _inner(update: "Update", context: ContextTypes.DEFAULT_TYPE):
#         inc(TG_UPDATES, type=name)
#         t0 = time.perf_counter()
#         try:
...
#             _wrap_with_graph("text", handle_text, graph),
#         )
#     )
#     app.add_handler(
#         MessageHandler(
#             filters.VOICE,
#             _wrap_with_graph("voice", handle_voice, graph),
#         )
#     )
#     app.add_handler(
#         MessageHandler(
#             filters.PHOTO,
#             _wrap_with_graph("photo", handle_photo, graph),
#         )
#     )
...
# def main():
#     # No asyncio.run here. Let PTB manage the loop inside run_polling().
#     configure_logging()
#     init_telemetry()
...
#     app.bot_data["container"] = c

#     log.info("Starting Telegram polling")
#     # PTB v20+ blocking call that manages the event loop internally
